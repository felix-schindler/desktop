...
public enum TagOperations {
    nonisolated public static func createArgs(name: String, targetCommitSha: String) -> [String] {
        ["tag", "-a", "-m", "", name, targetCommitSha]
    }

    nonisolated public static func deleteArgs(name: String) -> [String] {
        ["tag", "-d", name]
    }
    ...
    nonisolated public static func tagsToPushArgs(remoteName: String, branchName: String) -> [String] {
    ...
    nonisolated public static func normalizeTagName(_ rawTagName: String) -> String {
        var name = rawTagName
    ...
    nonisolated public static func parseShowRefTags(_ stdout: String) -> [String: String] {
    ...
    nonisolated public static func parseTagsToPush(_ stdout: String) -> [String] {
    ...
    nonisolated public static func validateTagName(_ name: String, existingTags: Set<String>) -> String? {
...
public enum TagLiveOperations {
    nonisolated public static func createTag(repositoryPath: String, name: String, targetCommitSha: String) async throws {
    ...
    nonisolated public static func deleteTag(repositoryPath: String, name: String) async throws {
    ...
    nonisolated public static func allTags(repositoryPath: String) async throws -> [String: String] {
    ...
    nonisolated public static func tagsToPush(repositoryPath: String, remoteName: String, branchName: String) async throws -> [String] {
